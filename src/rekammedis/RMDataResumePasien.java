    ...
    */
    ...
    private void isRawat() {
         ...
         if (Sequel.cariInteger("select count(no_rawat) from penilaian_medis_igd where no_rawat='" + TNoRw.getText() + "'") > 0) {
           ...
           JalannyaPenyakit.setText(Sequel.cariIsi("select ket_fisik from penilaian_medis_igd where no_rawat=?",TNoRw.getText()));
           ...
           Obat2an.setText(Sequel.cariIsi("select tata from penilaian_medis_igd where no_rawat=?",TNoRw.getText()));
            ...
            JalannyaPenyakit.setText(Sequel.cariIsi("select kondisi from penilaian_medis_ralan_penyakit_dalam where no_rawat=?", TNoRw.getText()));
            ...
            JalannyaPenyakit.setText(Sequel.cariIsi("select ket_lokalis from penilaian_medis_ralan_bedah where no_rawat=?", TNoRw.getText()));
            ...
            JalannyaPenyakit.setText(Sequel.cariIsi("select ket_fisik from penilaian_medis_ralan_anak where no_rawat=?", TNoRw.getText()));
            ...
            JalannyaPenyakit.setText(Sequel.cariIsi("select ket_fisik from penilaian_medis_ralan_kandungan where no_rawat=?", TNoRw.getText()));
            ...
            Keluhan.setText(Sequel.cariIsi("select keluhan from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' and nip='"+KodeDokter.getText()+"'"));
            JalannyaPenyakit.setText(Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' and nip='"+KodeDokter.getText()+"'"));
            Obat2an.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' and nip='"+KodeDokter.getText()+"'"));
        }
    }   
