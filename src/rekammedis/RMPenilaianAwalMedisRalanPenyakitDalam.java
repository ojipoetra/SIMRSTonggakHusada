        ...
        try {
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    Rad.setText(Sequel.cariIsi("select hasil from hasil_radiologi where no_rawat=?",TNoRw.getText()));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
                ...
                try {
                    ...
                    while (rsLab.next()) {
                        labResults.append("Pemeriksaan: ").append(rsLab.getString("Pemeriksaan"))
                                  .append("Nilai: ").append(rsLab.getString("nilai"))
                                  .append("\n");
                    }
                    Lab.setText(labResults.toString());
                } catch (Exception e) {
